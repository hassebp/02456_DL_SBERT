...
from preprocessing import generate_binary_answer_file
...
def run_tests():
    ...
    parser.add_argument('function', choices=['generate_bin','generate_urls','generate_triples','test_msmarco','test_training','check_cuda_availability','test_sbert','test_snli',
